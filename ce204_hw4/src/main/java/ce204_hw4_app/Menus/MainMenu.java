...
/**
  ...
  This package includes the main menu class, which represents the main menu of the system.
  The main menu allows users to select their role (vendor or user) or choose to exit the program.
 */
/**
 ...
 *
 *        The MainMenu class extends the Menu class and provides functionality
...
public class MainMenu extends Menu {
	 ...
	 *
	 *        The run() method prompts the user to select their role and performs
