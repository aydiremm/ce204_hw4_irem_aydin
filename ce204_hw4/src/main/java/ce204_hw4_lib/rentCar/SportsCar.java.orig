...
public class SportsCar extends Car {
	...
	/**
     * @brief Constructs a SportsCar object with the specified brand, model, and year.
     *
     ...
     *
     * This method overrides the displayInfo() method in the Car class to display specific information about the sports car.
     */
