 ...
 *
 *        This class represents a car rental vendor and provides methods to
 *        manage and calculate rental costs for cars.
 */
public class Vendor {
	/**
	 * @brief The unique identifier of the vendor.
	 */
	...
	/**
	 * @brief The contact information of the vendor.
	 */
	private String contactInformation;
	/**
	 * @brief The list of cars associated with the vendor.
	 */
	private List<Car> cars;
	/**
	 * @brief The rental cost for the vendor.
	 */
	 ...
	 *
	 *        This constructor creates a Vendor object with the provided vendor ID,
	 ...
	 *
	 *        This method calculates the rental cost by multiplying the base price
	 *        of the car type with the rental duration.
	 *
	 * @param rentalDuration The duration of the rental in days.
	 * @param carType        The type of the car (e.g., "economic", "luxury", "suv",
	 *                       "sports").
	 ...
	 *
	 *        This method returns the rental cost calculated by the previous call to
	 *        calculateRentalCost().
	 *
	 ...
	 *
	 *        This method checks if the specified car is present in the vendor's
	 *        inventory.
	 *
